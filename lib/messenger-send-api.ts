...
export function contactInfoMessage(): MessengerMessage {
  const text =
    ...
    "🍗 أو اكتب كلمة \"طلب\" هنا في الشات واطلب أونلاين في أقل من دقيقة، بنفس خطوات الطلب اللي هتلاقيها في المنيو.";
  return { text };
}
...
export function workingHoursMessage(): MessengerMessage {
  const text =
    ...
    "🍗 عايز تطلب دلوقتي؟ اكتب كلمة \"طلب\" هنا في الشات واطلب أونلاين في أقل من دقيقة.";
  return { text };
}
